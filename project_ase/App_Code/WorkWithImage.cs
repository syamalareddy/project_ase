...
/// <summary>
/// Summary description for WorkWithImage
/// </summary>
    public class WorkWithImage
    {
        ...
        //Methods declaration
        public WorkWithImage(string s, int width, int height)
        {
            this.text = s;
        ...
        public static byte[] ResizeImage(System.Drawing.Image imageToResize, int size)
        {
            int MAX_IMAGE_WIDTH_AND_HEIGHT = size;
            Decimal percentageOfMaxWidth = (decimal)MAX_IMAGE_WIDTH_AND_HEIGHT / imageToResize.Width;
            Decimal percentageOfMaxHeight = (decimal)MAX_IMAGE_WIDTH_AND_HEIGHT / imageToResize.Height;
